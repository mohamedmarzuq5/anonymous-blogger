...
export default function BlogCard({ color, blog, font, blogs }) {
  ...
  return (
    ...
    data-aos="zoom-in" data-aos-duration="1250">
      <div
        className={`rounded-2xl ${color ? `bg-gradient-to-r from-[#${color[0]}] to-[#${color[1]}]` : 'bg-[#FFFFFF]'} p-[3px] shadow-xl transition-transform ease-in-out duration-300 hover:scale-[1.03]`}
      >
        <Link
