            ...
            <nav className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto">
                ...
                <div className={`${!isOpen && 'hidden'} md:static w-full md:block md:w-auto`} id="navbar-default">
                    <ul className="font-normal lg:text-2xl justify-end flex flex-col p-4 md:p-0 mt-4 rounded-lg md:flex-row md:space-x-5 md:mt-0 md:border-0 md:bg-transparent bg-[#1E1E1E] border-[#A652C8] border-2">
                        <li>
                            <Link href={navData.link[0]} className="block py-2 pl-3 pr-4 md:border-0 md:p-0 text-white md:hover:text-blue-500 hover:bg-zinc-900 hover:text-white md:hover:bg-transparent" aria-current="page">{navData.text[0]}</Link>
                        </li>
                        <li>
                            <Link href={navData.link[1]} className="flex gap-x-1 py-2 pl-3 pr-4 rounded md:border-0 md:p-0 text-white md:hover:text-blue-500 hover:bg-zinc-900 hover:text-white md:hover:bg-transparent">{navData.text[1]}{" "}
