            ...
            <form>
              <label className="relative block">
                ...
                <span className="absolute inset-y-0 right-0 flex items-center">
                  <button type="submit" className={`${poppins} font-sans font-normal md:text-base text-xs lg:text-lg bg-gradient-to-r from-[#6157FF] to-[#EE49FD] md:rounded-lg rounded-md w-[70px] md:w-28 lg:w-32 h-[28px] md:h-10 lg:h-12 md:mr-3 mr-2 lg:mr-5 tracking-tighter text-[#FFFFFF]`}>Subscribe</button>
                </span>
                <span className="sr-only">Search</span>
